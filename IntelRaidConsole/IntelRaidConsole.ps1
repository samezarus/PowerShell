...
$terms += 'physicalDevicesCount'         # Êîëè÷åñòâî ñëîòîâ ïîä äèñêè
$terms += 'physicalDevicesDisks'         # Êîëè÷åñòâî âñòàâëåííûõ äèñêîâ
...
$app       = $PSScriptRoot+'\CmdTool2_64.exe' # Ïîñòàâèòü ãàëêó - Âûïîëíÿòü îò èìåíè àäìèíèñòðàòîðà
